...
namespace MusicPlayerDXMonoGamePort.HelperClasses
{
    ...
    {
        Font font = new Font(font.FontFamily, font.Size * superResoultion);
        Bitmap tmpTextBitmap = null, textBitmap = null;

        private const int superResoultion = 3;
        ...
        public void RenderToTexture(Texture2D tex, string textToDraw, int startPosX = 0, int startPosY = 0, SolidBrush color = null)
        {
            ...
            tmpTextBitmap = new Bitmap(tex.Width * superResoultion, tex.Height * superResoultion);
            Graphics g = Graphics.FromImage(tmpTextBitmap);
            g.SmoothingMode = SmoothingMode.AntiAlias;
            g.InterpolationMode = InterpolationMode.HighQualityBicubic;
            g.PixelOffsetMode = PixelOffsetMode.HighQuality;
            g.DrawString(textToDraw, font, color, startPosX * superResoultion, startPosY * superResoultion);
            g.Flush();
            textBitmap?.Dispose();
